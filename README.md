...
**搜索论文的常见途径**  
- arXiv：[website](https://arxiv.org/) ｜ 适合直接按关键词、作者、方向检索最新预印本
- arXiv Advanced Search：[website](https://arxiv.org/search/advanced) ｜ 适合按标题、作者、分类、日期做更精细的组合搜索
- alphaXiv：[website](https://www.alphaxiv.org/) ｜ 适合更快浏览论文页面、摘要与相关讨论
- Papers with Code：[website](https://paperswithcode.com/) ｜ 适合从任务、数据集、SOTA 与开源代码反查论文
- Hugging Face Daily Papers：[website](https://huggingface.co/papers) ｜ 适合快速浏览每天热度较高的新论文
- GitHub 开源项目与研究主页 ｜ 很多工作会先放代码仓库、project page、模型与数据链接
- X / Twitter ｜ 很多作者会先在这里发布论文、代码、实验视频和勘误
- 小红书 ｜ 适合看中文研究分享、论文速读和项目复现经验
- 微信公众号 ｜ 适合跟踪中文社区整理、综述解读与方向观察
